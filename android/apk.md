...
2. https://play.google.com/store/apps/details?id=com.dama.papercamera&feature=related_apps#?t=W251bGwsMSwxLDEwOSwiY29tLmRhbWEucGFwZXJjYW1lcmEiXQ..
3. https://play.google.com/store/apps/details?id=com.ljezny.pencilcamera&feature=also_installed#?t=W251bGwsMSwxLDEwNCwiY29tLmxqZXpueS5wZW5jaWxjYW1lcmEiXQ..

Android touchexample
code.google.com

Android底部工具栏
1. http://blog.csdn.net/chenxijie888/article/details/7411400 
2. http://griffinshi.iteye.com/blog/602737
3. http://flysnow.iteye.com/blog/938363
4. http://flysnow.iteye.com/blog/946564
5. http://www.cnblogs.com/FigoYu/archive/2010/11/20/1882691.html
...
Photoshop透明质感的按钮
玻璃按钮
http://www.68design.net/Graphic/Photoshop/53893-1.html
http://jingyan.baidu.com/article/1709ad80ced1db4634c4f00a.html
...
# Android分辨率
##屏幕尺寸  
屏幕尺寸指的是屏幕的物理尺寸，以屏幕的对角线长度作为依据。 
如2.8寸，3.5寸。 

Android简单将所有的屏幕尺寸简化为3大类： 
大，正常，小 
程序可以针对这3种尺寸的屏幕提供3种不同的布局方案，然后系统会负责把你的布局方案以合适的方式渲染到对应的屏幕上，这个过程是不需要程序员用代码来干预的。
...
密度 
密度wu关的像素（DIP） 
指一个抽象意义上的像素，程序用它来定义界面元素。 
在逻辑尺寸上，与一个位于像素密度为160DPI的屏幕上的像素是一致的。DIP缩放。
1. HVGA 320*480
2. WVGA 480*800
3. FWVGA 480*854
...
...
* 三种主要的尺寸： 大，正常，小
* 三种不同的密度： 高(hdpi), 中(mdpi), 低(ldpi)

##Android中的长度单位
dp, sp, px, pt, in, mm
dp就是dip, dp是与密度1关，sp除了与密度1关，还与sacle1关。
px：表示屏幕实际的像素
pt: 表示一个点，是屏幕的物理尺寸
